...
Days.prototype.selectedMonth = function(){
  console.log(months.indexOf(this.titleMonth()));
  console.log(new Date(this.titleYear(), months.indexOf(this.titleMonth()), 1));
  return new Date(this.titleYear(), months.indexOf(this.titleMonth()), 1);
};
